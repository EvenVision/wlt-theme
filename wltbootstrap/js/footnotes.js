...
//	Basically, this first collects all footnote links and bind mouseover and mouseout event
//	handlers to them. The mouseover handler searches for the proper footnote based on the footnote link's id. 
(function ($) {
...
var Footnotes = {
	...
	footnoteover: function() {
		...
		if(left + 450  > $(window).width() + $(window).scrollLeft())
			left = $(window).width() - 380 + $(window).scrollLeft();
